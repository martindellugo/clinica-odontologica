      ...
      //recorremos la colección de peliculas del JSON
         for(turno of data){
            ...
            turnoRow.innerHTML = '<td>' + turno.id + '</td>' +
                    ...
                    '<td class=\"td_nombrePaciente\">' + turno.nombrePaciente.toUpperCase() + '</td>' +
                    '<td class=\"td_apellidoPaciente\">' + turno.apellidoPaciente.toUpperCase() + '</td>' +
                    '<td class=\"td_odontologoId\">' + turno.odontologoId + '</td>' +
                    '<td class=\"td_apellidoOdontologo\">' + turno.apellidoOdontologo.toUpperCase() + '</td>' +
